...
const un = {
  ...
  defaultLanguage: "en",
  showWelcomeScreen: !1,
  initialMessages: [ "My name is David Ai. How can I assist you today?"],
  i18n: {
    en: {
      title: "Hi there! 👋",
...
const rp = { class: "chat-get-started-footer" }, sp = { key: 0 }, op = /* @__PURE__ */ Ve({
...
const T7 = /* @__PURE__ */ Ys(S7), D7 = /* @__PURE__ */ Ve({
  ...
  __name: "Chat",
  setup(t) {
    const { t: e } = Tr(), n = no(), { messages: r, currentSessionId: s } = n, { options: o } = Rn();
    async function i() {
...
// Function to add the powered by
document.addEventListener('DOMContentLoaded', function() {
  ...
  function addPoweredBy() {
      ...
      if (document.querySelector('.chat-powered-by')) {
          return;
      }
      ...
      if (chatFooter) {
          ...
          poweredBy.className = 'chat-powered-by';
          poweredBy.innerHTML = 'Powered by <a href="https://davidrt.xyz/">David RT</a>';


          chatFooter.appendChild(poweredBy);
          console.log('Powered by añadido correctamente');
      } else {
          console.error('No se encontró el elemento .chat-footer');
      }
  }
  ...
  function tryAddPoweredBy() {
      addPoweredBy();
      attempts++;

      if (attempts < maxAttempts && !document.querySelector('.chat-powered-by')) {
          setTimeout(tryAddPoweredBy, 1000);
      }
  }
